...
for t = 1:2500
    ...
    %  Evoluzione dello Stato (Modello Linearizzato)
    [A_lin, B_lin, d_lin] = Linearized_Model(x_current, u_prev, Ts, L);
    
    % x(k+1) = A*x(k) + B*u(k) + d
    x_next = A_lin * x_current + B_lin * u_opt + d_lin;
...
fprintf('\n');
fprintf('==============================================================\n');
fprintf('   REPORT FINALE - PURE PURSUIT                               \n');
fprintf('==============================================================\n');
...
fprintf('| NOTA: L''angolo finale dipende dalla direzione di arrivo.   |\n');
fprintf('==============================================================\n');
